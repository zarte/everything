...
/*
 *  农历数据来源:1900-2100
 *  香港天文台数据：http://data.weather.gov.hk/gts/time/conversion1_text_c.htm
 *  紫金山天文台数据(http://www.pmo.ac.cn/jgsz/yjsz/yyttlxykjmbyspyjb/lshtwckx/):暂无
 *
 *  修正指南:
 *  $lunars: 0101 1010 1100 0000 要转成16进制
 *  第一位开始1月1代表大月300代表小月29，最后4位代表润月是几
 *  $solarTerms:9778397bd097c36b0b6fc9274c91aa 16转十 621419 520420 521521 722723 723823 722721
 *  节气从小寒1开始到二十四,每组 1 2 1 2为对应日期
 *
 * 
 *  $result = $calendar->solar(date('Y'), date('n'), date('j')); //获取阴历
//$result = $calendar->solar(2017, 5, 5); // 获取阳历
//$result = $calendar->solar(2017, 5, 5, 23); // 获取阳历，带 $hour 参数
 *
 */
...
class Calendar
{
    ...
    protected $lunars = [
        ...
        0x04af5, 0x04970, 0x064b0, 0x074a3, 0x0ea50, 0x06b58, 0x05ac0, 0x0ab60, 0x096d5, 0x092e0, // 1990-1999 96:0ab60->0x055c0
    ...
    protected function getColor($ganZhi)
    {
        ...
        //20180420修改$this->colors[array_search($this->gan,$gan)]
    ...
    protected function getWuXing($ganZhi)
    {
        ...
        //20180420修改$this->wuXing[array_search($this->gan,$gan)]
    ...
    public function solar2lunar($year, $month, $day, $hour = null)
    {
        ...
        $term = '';
        !empty($termIndex) && $term = $this->solarTerm[$termIndex];
